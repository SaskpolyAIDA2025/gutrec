...
# -----------------------
OPENAI_API_KEY = "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"
...
client = weaviate.Client(
    ...
    additional_headers={"X-OpenAI-Api-Key": OPENAI_API_KEY}  # needed if vectorizer is text2vec-openai
)
...
book_class = {
    ...
    "vectorizer": "text2vec-openai",  # OpenAI vectorization enabled
    "properties": [
