...
book_class = {
    ...
    "vectorizer": "none",  # <- DISABLES OpenAI / AI vectorization
    "properties": [
...
def fetch_books(max_pages=5):  # default to 5 pages
    next_url = API_URL
    page_count = 0
    ...
    while next_url:
        ...
        try:
            ...
            for book in data.get('results', []):
                ...
                # Insert without vector (no OpenAI)
                try:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fetch books from Gutendex and push to Weaviate (no AI).")
